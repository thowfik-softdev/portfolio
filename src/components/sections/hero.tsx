    ...
    <section className="max-w-5xl mx-auto px-6 py-16 md:py-24">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12">
        ...
        <div className="md:col-span-8">
          ...
          <h2 className="font-heading text-4xl md:text-6xl lg:text-7xl font-black leading-[0.95] tracking-tight mb-6">
          ...
          <p className="font-serif text-lg md:text-xl text-muted-foreground leading-relaxed max-w-xl drop-cap">
            {hero.summary}
          </p>
        </div>
